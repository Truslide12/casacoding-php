  ...
  <body>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div>
                <img src="assets/img/Carlos_Aragon.jpg" class="img-thumbnail" style="width:15%">
            </div>
    ...
    <div class="footer">
        ...
        <p></p>
        <a href="https://github.com/Truslide12"><img class="footer-img" src="{{asset('/assets/img/githublogo.gif')}}"></a>
        <p></p>
        <a href="https://www.linkedin.com/in/carlos-aragon-a2839512">
            <img class="footer-img" src="{{asset('/assets/img/linkdin.png')}}"></a>
    </div>
